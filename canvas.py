...
ser=serial.Serial('COM8', baudrate=9600, timeout=0.1)
# Define the upper and lower boundaries for a color to be considered "Blue"
#blueLower = np.array([100, 60, 60])
#blueUpper = np.array([140, 255, 255])
greenLower=np.array([50,65,48])#50,65,48
...
while 1:
    ...
    blueMask = cv2.inRange(hsv, greenLower, greenUpper)
    ...
    if len(cnts) > 0:
        ...
        # will assume this contour correspondes to the area of the bottle cap .area for blue 1200 and 20000
